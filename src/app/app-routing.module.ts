...
const routes: Routes = [{ path: 'stages',canActivate:[DataUserGuard,AuthGuard], loadChildren: () => import('./stages/stages.module').then(m => m.StagesModule) },
 { path: 'users',canActivate:[DataUserGuard,AuthGuard], loadChildren: () => import('./users/users.module').then(m => m.UsersModule) },
  { path: 'formations',canActivate:[DataUserGuard,AuthGuard], loadChildren: () => import('./formations/formations.module').then(m => m.FormationsModule) },
   { path: 'bibliotheques',canActivate:[DataUserGuard,AuthGuard], loadChildren: () => import('./bibliothequess/bibliothequess.module').then(m => m.BibliothequessModule) },
    { path: 'quiz',canActivate:[DataUserGuard], loadChildren: () => import('./quizs/quizs.module').then(m => m.QuizsModule) },
